...
int main(int argc, char* argv[], char** env) {
  ...
  tests::autoTestSortChangeSize(
      tests::FuncSort::QUICK, tests::Layout::NO_SORT, 10, 1'000'001, 10'000);

  tests::autoTestSortChangeSize(
      tests::FuncSort::QUICK, tests::Layout::INC_SORT, 10, 1'000'001, 10'000);

  tests::autoTestSortChangeSize(
      tests::FuncSort::QUICK, tests::Layout::DEC_SORT, 10, 1'000'001, 10'000);


  // Tests avlSort (ChangeSize)
  tests::autoTestSortChangeSize(
      tests::FuncSort::AVL, tests::Layout::NO_SORT, 10, 1'000'001, 10'000);

  tests::autoTestSortChangeSize(
      tests::FuncSort::AVL, tests::Layout::INC_SORT, 10, 1'000'001, 10'000);

  tests::autoTestSortChangeSize(
      tests::FuncSort::AVL, tests::Layout::DEC_SORT, 10, 1'000'001, 10'000);
