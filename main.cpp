...
static void testAvlTreeLong(std::vector<int>& elems, size_t countTest) {
  std::cout << __FUNCTION__ << "()\n";
...
static void testQuickSortLong(std::vector<int>& elems, size_t countTest) {
  std::cout << __FUNCTION__ << "()\n";
...
int main(int argc, char* argv[], char** env) {
  ...
  testAvlTreeLong(elems, countTest);
  testQuickSortLong(elems, countTest);
